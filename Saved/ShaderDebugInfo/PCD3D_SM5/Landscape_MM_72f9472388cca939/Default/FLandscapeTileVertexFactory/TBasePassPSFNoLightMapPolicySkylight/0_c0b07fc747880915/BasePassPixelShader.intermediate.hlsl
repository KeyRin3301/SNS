...
void frag_main()
{
    ...
    float4 _447 = Material_Texture2D_0.Sample(View_LandscapeWeightmapSampler, in_var_TEXCOORD1.xy);
    float _450 = dot(_447, Material_Material_PreshaderBuffer[0]);
    float _453 = dot(_447, Material_Material_PreshaderBuffer[1]);
    float _456 = dot(_447, Material_Material_PreshaderBuffer[2]);
    float _459 = dot(_447, Material_Material_PreshaderBuffer[3]);
    float4 _462 = Material_Texture2D_1.Sample(View_LandscapeWeightmapSampler, in_var_TEXCOORD1.xy);
    float _465 = dot(_462, Material_Material_PreshaderBuffer[4]);
    ...
    float _691 = mad(clamp(mad(_671.y * Material_Material_PreshaderBuffer[7].w, _465, mad(_665.y, _459, mad(_659.y, _456, mad(_647.y, _450, _652.y * _453)))), 0.0f, 1.0f), View_View_RoughnessOverrideParameter.y, View_View_RoughnessOverrideParameter.x);
    float _692 = clamp(mad(_671.x, _465, mad(_665.x, _459, mad(_659.x, _456, mad(_647.x, _450, _652.x * _453)))), 0.0f, 1.0f);
