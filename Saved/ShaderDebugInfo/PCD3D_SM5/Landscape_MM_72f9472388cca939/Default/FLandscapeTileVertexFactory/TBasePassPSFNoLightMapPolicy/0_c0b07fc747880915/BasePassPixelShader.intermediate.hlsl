...
void frag_main()
{
    ...
    float4 _456 = Material_Texture2D_1.Sample(View_LandscapeWeightmapSampler, in_var_TEXCOORD1.xy);
    float _459 = dot(_456, Material_Material_PreshaderBuffer[4]);
    ...
    float _685 = mad(clamp(mad(_665.y * Material_Material_PreshaderBuffer[7].w, _459, mad(_659.y, _453, mad(_653.y, _450, mad(_641.y, _444, _646.y * _447)))), 0.0f, 1.0f), View_View_RoughnessOverrideParameter.y, View_View_RoughnessOverrideParameter.x);
    float _686 = clamp(mad(_665.x, _459, mad(_659.x, _453, mad(_653.x, _450, mad(_641.x, _444, _646.x * _447)))), 0.0f, 1.0f);
