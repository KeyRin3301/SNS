...
void frag_main()
{
    ...
    float _446 = dot(Material_Texture2D_0.Sample(View_LandscapeWeightmapSampler, in_var_TEXCOORD1.xy), Material_Material_PreshaderBuffer[0]);
    float4 _449 = Material_Texture2D_1.Sample(View_LandscapeWeightmapSampler, in_var_TEXCOORD1.xy);
    float _452 = dot(_449, Material_Material_PreshaderBuffer[1]);
    float _455 = dot(_449, Material_Material_PreshaderBuffer[2]);
    float _458 = dot(_449, Material_Material_PreshaderBuffer[3]);
    float _461 = dot(_449, Material_Material_PreshaderBuffer[4]);
    ...
    float _687 = mad(clamp(mad(_667.y * Material_Material_PreshaderBuffer[7].w, _461, mad(_661.y, _458, mad(_655.y, _455, mad(_643.y, _446, _648.y * _452)))), 0.0f, 1.0f), View_View_RoughnessOverrideParameter.y, View_View_RoughnessOverrideParameter.x);
    float _688 = clamp(mad(_667.x, _461, mad(_661.x, _458, mad(_655.x, _455, mad(_643.x, _446, _648.x * _452)))), 0.0f, 1.0f);
