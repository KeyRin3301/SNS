...
void frag_main()
{
    ...
    float _452 = dot(Material_Texture2D_0.Sample(View_LandscapeWeightmapSampler, in_var_TEXCOORD1.xy), Material_Material_PreshaderBuffer[0]);
    float4 _455 = Material_Texture2D_1.Sample(View_LandscapeWeightmapSampler, in_var_TEXCOORD1.xy);
    float _458 = dot(_455, Material_Material_PreshaderBuffer[1]);
    float _461 = dot(_455, Material_Material_PreshaderBuffer[2]);
    float _464 = dot(_455, Material_Material_PreshaderBuffer[3]);
    float _467 = dot(_455, Material_Material_PreshaderBuffer[4]);
    ...
    float _693 = mad(clamp(mad(_673.y * Material_Material_PreshaderBuffer[7].w, _467, mad(_667.y, _464, mad(_661.y, _461, mad(_649.y, _452, _654.y * _458)))), 0.0f, 1.0f), View_View_RoughnessOverrideParameter.y, View_View_RoughnessOverrideParameter.x);
    float _694 = clamp(mad(_673.x, _467, mad(_667.x, _464, mad(_661.x, _461, mad(_649.x, _452, _654.x * _458)))), 0.0f, 1.0f);
